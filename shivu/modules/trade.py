...
async def trade(client, message):
    ...
    if img_url.endswith(('.mp4', '.gif')):
        await message.reply_video(video=img_url, caption=f"{message.reply_to_message.from_user.mention}, do you accept this trade?", reply_markup=keyboard)
    else:
        await message.reply_photo(photo=img_url, caption=f"{message.reply_to_message.from_user.mention}, do you accept this trade?", reply_markup=keyboard)
...
async def gift(client, message):
    ...
    if img_url.endswith(('.mp4', '.gif')):
        await message.reply_video(video=img_url, caption=f'Do you really want to gift <b>{character["name"]}</b> to <b>{message.reply_to_message.from_user.mention}</b>?', reply_markup=keyboard)
    else:
        await message.reply_photo(photo=img_url, caption=f'Do you really want to gift <b>{character["name"]}</b> to <b>{message.reply_to_message.from_user.mention}</b>?', reply_markup=keyboard)
